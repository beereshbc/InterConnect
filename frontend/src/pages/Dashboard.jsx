      ...
      >
        ...
        <div
          style={{
            ...
            height: "50vw",
            background:
              "radial-gradient(circle, rgba(124,92,252,0.15) 0%, rgba(0,0,0,0) 70%)",
            filter: "blur(60px)",
            zIndex: 0,
          }}
        />
        <div
          style={{
            ...
            height: "50vw",
            background:
              "radial-gradient(circle, rgba(79,142,247,0.1) 0%, rgba(0,0,0,0) 70%)",
            filter: "blur(60px)",
            zIndex: 0,
          }}
        />
        ...
        >
          ...
          >
            ...
            >
              <strong style={{ color: "#fff" }}>
                You're cordially invited to Interconnect 26.0 — happening TODAY!
              </strong>
            </p>
            <p
              style={{
            ...
            >
              A collaborative, interdisciplinary platform that brings together
              innovative minds to explore, create, and solve real-world
              challenges through technology and teamwork. Join us for an
              experience of learning, building, and connecting with passionate
              developers, thinkers, and creators.
            </p>
          </motion.div>
          ...
          >
            {[
              {
                icon: <Globe size={20} />,
                text: "Real-world industry projects",
                color: "#4f8ef7",
              },
              {
                icon: <Rocket size={20} />,
                text: "Open source contributed work",
                color: "#22d3a0",
              },
              {
                icon: <Users size={20} />,
                text: "Collaborative builds you join",
                color: "#f5a623",
              },
            ].map((item, i) => (
              <div
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(79, 142, 247, 0.05) 0%, rgba(124, 92, 252, 0.05) 100%)",
              border: "1px solid rgba(124, 92, 252, 0.2)",
              borderRadius: "20px",
              padding: "24px",
              marginBottom: "36px",
          ...
          >
            ...
            >
              <Calendar style={{ color: "#7c5cfc" }} size={24} />
            ...
            <div style={{ display: "grid", gap: "20px" }}>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <MapPin size={14} /> Rooms C-132 & C-135{" "}
                    <span style={{ margin: "0 6px" }}>|</span> 10:30 AM
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <MapPin size={14} /> GM Halamma Auditorium{" "}
                    <span style={{ margin: "0 6px" }}>|</span> 12:30 PM
                  </div>
                </div>
              </div>
            </div>
          ...
          <motion.div variants={itemVariants} style={{ textAlign: "center" }}>
            ...
            >
              Whether you're a coder, designer, thinker, or just curious —
              there's a place for you here. Meet like-minded people, spark
              ideas, and take your first (or next) big step.
              <br />
              <br />
              <strong style={{ color: "#fff" }}>
            ...
            >
              <CheckCircle2 size={16} /> Open to all GM Gems students — Free
              entry!
            </div>
            ...
            >
              Don't miss it. See you there, Gem! ✨
            </p>
          </motion.div>
        </motion.div>
      </div>
